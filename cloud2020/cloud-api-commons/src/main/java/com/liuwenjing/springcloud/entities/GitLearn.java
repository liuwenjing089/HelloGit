package com.liuwenjing.springcloud.entities;
...
public class GitLearn {
    public static void main(String[] args) {
        ...
        System.out.println("远程分支master,与本地dev:local-liuwenjing-dev冲突--EIGHT");
        System.out.println("远程分支master,与本地dev:local-liuwenjing-dev冲突--NINE");
